(*
	@Purpose:
		Commit message, push options, and author helpers for Sourcetree.

	@Project:
		applescript-core-apps3

	@Build:
		./scripts/build-lib.sh 'App Wrappers/Sourcetree/4.2.11/dec-sourcetree-commit'

	@Created: Sat, Jul 11, 2026 at 05:21:28 PM
	@Last Modified: Fri, Sep 18, 2026 at 08:30:00 AM
	@Change Logs:
		Fri, Sep 18, 2026, at 08:30:00 AM - Moved commit UI handlers from sourcetree.applescript
*)
