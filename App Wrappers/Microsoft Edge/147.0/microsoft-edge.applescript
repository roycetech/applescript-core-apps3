(*
	...
	@Build:
		./scripts/build-lib.sh 'App Wrappers/Microsoft Edge/147.0/microsoft-edge'
		
	@Change Logs:
		Sun, Apr 26, 2026, at 05:04:55 PM - Add #isPlaying handler.
...
on new()
	...
	script MicrosoftEdgeInstance
		...
		(*
			ChatGPT, detect video playing via JavaScript
		*)
		on isPlaying()
			tell application "Microsoft Edge"
