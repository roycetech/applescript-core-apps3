(*
	...
	@Build:
		./scripts/build-lib.sh 'App Wrappers/Microsoft Edge/147.0/dec-microsoft-edge-tab-finder'
	...
	@Difference from MS Edge - Safari
...
on spotCheck()
	...
	set cases to listUtil's splitAndTrimParagraphs("
		...
		(17.) Manual: Find Tab by URL Substring
	...
	if caseIndex is 2 then
		...
		set sutSubstring to "www.udemy.com"
		logger's debugf("sutSubstring: {}", sutSubstring)
