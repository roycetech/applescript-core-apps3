(*
	...
	@Build:
		./scripts/build-lib.sh 'App Wrappers/Sequel Ace/5.2/sequel-ace-tab'
	...
	script SequelAceTabInstance
		...
		on switchDatabase(databaseName)
			tell application "System Events" to tell process "Sequel Ace"
				...
				try
					click menu item databaseName of menu 1 of pop up button 1 of toolbar 1 of front window
				on error
